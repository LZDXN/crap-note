  ...
  return (
    <footer className="border-t border-[color:var(--color-line)] mt-12 py-6">
      <div className="mx-auto max-w-5xl px-5 sm:px-8 text-[11px] text-[color:var(--color-muted)] flex flex-wrap items-center justify-between gap-2">
        <a
          href="https://github.com/LZDXN/crap-note"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="View source on GitHub"
          className="inline-flex items-center gap-1.5 hover:text-[color:var(--color-ink)] transition-colors"
          >
          <svg
            width="14"
            height="14"
          ...
          <span>Find Project Source Code Here</span>
        </a>
